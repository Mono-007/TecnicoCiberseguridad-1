Proceso ControlSeguridad
	Definir maxReg, cant, opcion Como Entero
    Definir usuarios, claves, estado Como Cadena
    ...
    Repetir
		Escribir ""
        Escribir "== SISTEMA DE VALIDACIÓN DE CLAVES =="
        Escribir "1. Agregar registro"
        Escribir "2. Ver registros"
        Escribir "3. Salir"
        Leer opcion
